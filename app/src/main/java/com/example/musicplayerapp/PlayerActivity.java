...
public class PlayerActivity extends AppCompatActivity {
    Button playbtn, nextbtn, previousbtn, fforwardbtn, frewindbtn;
    TextView txtsname, txtsstart, txtsstop, albumname, artistname, genrename, year;
    SeekBar seekmusic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fforwardbtn = findViewById(R.id.fforwardbtn);
        frewindbtn = findViewById(R.id.frewindbtn);
        ...
        String txtsn = mediaMetadataRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_TITLE);
        ...
        //for album cover i will use the imageView
        ...
        updateseekbar = new Thread()
        {
            ...
            public void run() {
                ...
                int currentpotision = 0;

                while (currentpotision < totalDuration) {
                    try {
                        sleep(500);
                        currentpotision = mediaPlayer.getCurrentPosition();
                        seekmusic.setProgress(currentpotision);
        ...
        fforwardbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mediaPlayer.isPlaying()) {
        ...
        frewindbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mediaPlayer.isPlaying()) {
                    mediaPlayer.seekTo(mediaPlayer.getCurrentPosition() - 10000);
